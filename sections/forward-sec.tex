...
\begin{figure}[!ht]
    \centering
    \input{figures/fkem_hibe_interaction}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.33\textwidth}
        \centering
        \input{figures/fkem_hibe_example1-1}
        \caption{Delegating $\sk_{10}$}
        \label{fig:fkem:hibe:example1-1}
    \end{subfigure}\hfill
    \begin{subfigure}{.33\textwidth}
        \centering
        \input{figures/fkem_hibe_example1-3}
        \caption{Delegating co-path}
        \label{fig:fkem:hibe:example1-3}
    \end{subfigure}
    \begin{subfigure}{.33\textwidth}
        \centering
        \input{figures/fkem_hibe_example1-4}
    ...
    \begin{subfigure}{.33\textwidth}
        \centering
        \input{figures/fkem_hibe_example2-1}
        \caption{Delegating $\sk_{00}$}
        \label{fig:fkem:hibe:example2-1}
    \end{subfigure}\hfill
    \begin{subfigure}{.33\textwidth}
        \centering
        \input{figures/fkem_hibe_example2-3}
        \caption{Delegating co-path}
        \label{fig:fkem:hibe:example2-3}
    \end{subfigure}
    \begin{subfigure}{.33\textwidth}
        \centering
        \input{figures/fkem_hibe_example2-4}
        \caption{Removing used secret keys}
