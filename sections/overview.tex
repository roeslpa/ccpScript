...
\end{figure}
%To achieve this notion of security, we will use the main building blocks from above to construct a secure protocol, fig.\ \ref{fig:simplified_secure_protocol} shows a simplified example of this.

\begin{figure}
    \centering
    \input{figures/simplified_secure_protocol}
    \caption{}
    \label{fig:simplified_secure_protocol}
\end{figure}
