...
Instead of giving the adversary the original ElGamal ciphertext~$c_2=\ek^x\cdot m_b$ for the challenge message~$m_b$, we give the adversary~$c_2'=\DHg^z\cdot m_b$.
