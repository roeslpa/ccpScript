...
For simplicity and clarity, we refrain from considering concrete group generation algorithms, and we do not elaborate on hardness analyzes of the DDH problem.
