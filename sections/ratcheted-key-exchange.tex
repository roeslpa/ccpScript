...
The seeded generation of key material has two purposes:
It ensures forward security for the receiver, and it makes sure that, when sender and receiver process different ciphertexts (due to active attack against the sender-to-receiver ciphertexts), the key material of both communication participants is diverged and becomes incompatible.
