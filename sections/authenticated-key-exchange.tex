...
The Noise Framework \cite{NoiseFramework} is a set of rules to combine Diffie-Hellman key exchange with Authenticated Encryption~(AE). \textcite{PKC:DowRosSch20,CCS:ADHSW22} provide a deeper analysis.
