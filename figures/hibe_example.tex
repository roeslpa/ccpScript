...
\begin{tikzpicture}
    ...
    % This produces a "mailto: " link in the PDF, which is not ideal, but I don't know how to prevent it.
    ...
    %TF
    \draw[densely dotted] (TF) -- (BOB) node [pos=0.8, right] {$\sk''''\gets\HIBEdel(\sk''',\text{``bob''})$};
