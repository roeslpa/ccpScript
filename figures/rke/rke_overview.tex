...
\begin{tikzpicture}
    ...
    %Left side FS-arrows
    \draw[->|, greenb] (.5, -.5) -- (.5, -1.25) node [midway,left] {FS};
    \node at (.5, -1.5) {\color{redb}\Large\Lightning}; % corruption arrow
    \draw[|->|, greenb] (.5, -1.75) -- (.5, -3.25);
    \draw[|->, greenb] (.5, -3.75) -- (.5, -5);

    %Right side FS-arrows
    \draw[->|, greenb] (8.5, -.5) -- (8.5, -1.25);
    \draw[|->|, greenb] (8.5, -1.75) -- (8.5, -3.25);
    \node at (8.5, -3.5) {\color{redb}\Large\Lightning}; %corruption arrow
    \draw[|->, greenb] (8.5, -3.75) -- (8.5, -5) node [midway, right] {PCS};
