...
\begin{figure}[!ht]
      \centering
      \fbox{\scalebox{\codescalefactor}{\input{figures/sig_based_auth}}}
...
\begin{figure}[!ht]
     \centering
     \fbox{\scalebox{\codescalefactor}{\input{figures/kem_based_auth}}}
...
\begin{figure}[!ht]
    \centering
    \fbox{\scalebox{\codescalefactor}{\input{figures/unidirectional_rke}}}
