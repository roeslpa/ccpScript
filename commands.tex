...
% "\skiplines{x} inserts "\\ \strut\\ \strut\\..." so that x lines are skipped.
% Used to create blank lines in "boxes-and-arrows style proofs without triggering the underfull badness error"
\usepackage{pgffor}
\newcommand{\skiplines}[1]{%
  \foreach \i in {1,...,#1} {\strut \\}%
}
...
% Define some nicer (darker) colors for better readability
% these don't get used in every figure with colors, but sometimes the predefined colors "red"
% and "green" are too bright.
\colorlet{greenb}{green!80!black}
\colorlet{redb}{red!90!black}

% simple environment for comments of the style "// foobar"
\newcommand{\codecomment}[1]{\textcolor{gray!90}{// #1}}
